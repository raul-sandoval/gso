...
########## @discovery_toolkit_blueprint.route("/dna/<account_id>",methods=['GET']) [START] ##########
@discovery_toolkit_blueprint.route("/dna/<account_id>",methods=['GET'])
def dna(account_id):
    ...
    df_data = fnGetGSE_GTDP_DNA(account_id,'DNA',False)
    ...
    return render_template(APP_NAME + '/dna.html',response=response)
########## @discovery_toolkit_blueprint.route("/dna/<account_id>",methods=['GET'])  [END]  ##########