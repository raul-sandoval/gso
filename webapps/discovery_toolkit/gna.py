...
########## @discovery_toolkit_blueprint.route("/gna/<account_id>",methods=['GET']) [START] ##########
@discovery_toolkit_blueprint.route("/gna/<account_id>",methods=['GET'])
def gna(account_id):
    ...
    df_data = fnGetGSE_GTDP_DNA(account_id,'GSE',False)
    ...
    return render_template(APP_NAME + '/gna.html',response=response)
########## @discovery_toolkit_blueprint.route("/gna/<account_id>",methods=['GET'])  [END]  ##########